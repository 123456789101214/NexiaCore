...
const Customers = () => {
    ...
    const fetchCustomers = async (search = '') => {
        try {
            setIsLoading(true);
            // 💡 SaaS FIX: Passing both search and toggle state
            const res = await customerService.getCustomers(search, showInactive);
            setCustomers(res.data.data); // Ensure res.data.data is used based on controller
        } catch (error) {
    ...
    // ... handleAddCustomer, handleEditCustomer, handlePayment (Keep your original logic) ...
