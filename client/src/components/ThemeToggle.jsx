...
const ThemeToggle = () => {
    ...
    return (
        // 🚀 FIX: Added 'ml-2' just to guarantee it never touches the text
        <div className="shrink-0 flex items-center justify-center w-[64px] h-[32px] md:w-[80px] md:h-[40px] ml-2">
            <button
                onClick={toggleTheme}
                className={`relative shrink-0 inline-flex h-10 w-20 scale-[0.8] md:scale-100 origin-center items-center rounded-full transition-all duration-500 ease-in-out focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 overflow-hidden shadow-inner ${
