...
router.get('/stock-forecast', protect, authorize('admin', 'owner', 'manager'), getStockForecast);
router.get('/chart-data', protect, authorize('owner', 'admin', 'manager'), getSalesChartData);
